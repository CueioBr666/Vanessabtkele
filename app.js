...
const stringSession = new StringSession("");
...
const Grupos = [
{ chat: "MkBuscas02Robot", comando: 'nome',bot:'MkBuscas02Robot'},
{ chat: "MkBuscas02Robot", comando: 'cpf2',bot:'MkBuscas02Robot'},
{ chat: "MkBuscas02Robot", comando: 'tel1',bot:'MkBuscas02Robot'},
{ chat: "MkBuscas02Robot", comando: 'placa1',bot:'MkBuscas02Robot'},
{ chat: "MkBuscas02Robot", comando: 'cpf1',bot:'MkBuscas02Robot'},
{ chat: "MkBuscas02Robot", comando: 'cpf4',bot:'MkBuscas02Robot'},
...
function getGroupForCommand(command) {
    ...
    return { chat: "MkBuscas02Robot", comando: 'cpf', bot:'MkBuscas02Robot' }; // Ou um valor padrão, dependendo do caso
}
